...
class IngredientsVege : Fragment() {
    ...
    fun searchOptions(view: View) {
        ...
        val fragments: Array<Fragment> = arrayOf(IngredientsSpices(), IngredientsMeat(), IngredientsFruits())
...
//        commitChange(vege, fragments[0], "ingredient_search_vegetables")
        ...
        commitChange(meat, fragments[1], "ingredient_search_meat")
        commitChange(fruits, fragments[2], "ingredient_search_fruits")
