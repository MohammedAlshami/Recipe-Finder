...
import com.example.recipe.fragments.Recipe2
import com.example.recipe.fragments.Result

class Malay : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view =  inflater.inflate(R.layout.fragment_malay, container, false)
        recipeOptions(view)
        backBtn(view)
        return view
    }
    ...
    fun recipeOptions(view: View) {
        ...
        val fragments: Array<Fragment> = arrayOf(Recipe2(), Recipe2(), Camera())

        // Function to replace fragments on click

        commitChange(recipe1, fragments[0], "recip1")
        commitChange(recipe2, fragments[0], "recip2")
